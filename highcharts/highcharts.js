...
///////////////////////////////////////////////////////////////////////
// #1 4/9/14, 4/10/14 amd-fication (also added dependency to jQuery)
//
// #2 4/9/14 amd-fication - Highcharts removed from global namespace
//
// #3 4/25/2014 replaced "doc" variable by document related to container element.
//              It fixes zoom if chart rendered in iframe.
//
// #4 4/25/2014 use local jQuery variable, not from win.jQuery
//
// #5 7/21/2014 revert Highcharts bug 2466
//
// #6 7/29/2014 extend reset zoom button options for html rendering
//
// #7 8/28/2014 fix legend font scaling
//
// #8 25/10/2015 JRS-7150: getting back removed code to display tooltips for Time Series Heat Map
//
///////////////////////////////////////////////////////////////////////
...
//END JASPERSOFT #1
    ...
    //JASPERSOFT #4
    Highcharts.loadAdapter(win.HighchartsAdapter || jQuery);
    //END JASPERSOFT #4
    /* ****************************************************************************
     * Handle the options                                                         *
     *****************************************************************************/
    ...
    */
    ...
    extend(Chart.prototype, {
        ...
        showResetZoom: function () {
            ...
            this.resetZoomButton = chart.renderer.button(lang.resetZoom, null, null, zoomOut, theme, states && states.hover /*JASPERSOFT #6*/, UNDEFINED, UNDEFINED, UNDEFINED, chart.options.chart.isHeatMapTimeSeriesChart /*END JASPERSOFT #6*/)
                .attr({
